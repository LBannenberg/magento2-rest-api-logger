...
use Corrivate\RestApiLogger\Block\Adminhtml\Form\Field\ComparisonCondition;
use Corrivate\RestApiLogger\Block\Adminhtml\Form\Field\ResponseConsequence;
use Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray;
use Magento\Framework\DataObject;
use Magento\Framework\View\Element\BlockInterface;

class HttpStatusFilters extends AbstractFieldArray
{
    /** @var BlockInterface */
    ...
    protected function _prepareToRender()
    {
        ...
        $this->addColumn('value', ['label' => (string)__('HTTP Status')]);
